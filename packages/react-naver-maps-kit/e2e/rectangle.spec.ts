...
test.describe("2. bounds/options 반영", () => {
  ...
  test("R-15: strokeLineCap/strokeLineJoin/strokeStyle changed 이벤트가 발생한다", async ({ page }) => {
...
test.describe("4. Ref 기반 imperative 동작", () => {
  ...
  test("R-30: ref.getAreaSize/getDrawingRect/getElement/getBounds가 유효값을 반환한다", async ({ page }) => {
    await page.getByTestId("ref-read-state").click();
