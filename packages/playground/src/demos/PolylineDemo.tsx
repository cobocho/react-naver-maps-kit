...
function PolylineDemoBase() {
  ...
  const [strokeStyle, setStrokeStyle] = useState<"solid" | "shortdash" | "longdash" | "dot">(
    "solid"
  );
  ...
  return (
    <>
      ...
      <p className="demo-description">경로 라인의 스타일, 선 패턴, 이벤트를 제어합니다.</p>

      <div className="map-container">
        <NaverMap
          defaultCenter={{ lat: 37.567, lng: 126.98 }}
          defaultZoom={15}
      ...
      <div className="controls-panel">
        ...
        <div className="controls-grid">
          ...
          <div className="control-item">
            ...
            <select
              value={strokeStyle}
              onChange={(e) => setStrokeStyle(e.target.value as typeof strokeStyle)}
            >
