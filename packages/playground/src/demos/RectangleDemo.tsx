  ...
  return (
    <>
      ...
      <p className="demo-description">
        사각형 오버레이의 bounds, 스타일, 이벤트를 제어합니다.
      </p>

      <div className="map-container">
        <NaverMap defaultCenter={DEFAULT_CENTER} defaultZoom={15} style={{ width: "100%", height: 500 }}>
          <Rectangle
            bounds={bounds}
            fillColor={fillColor}
      ...
      <div className="controls-panel">
        ...
        <div className="controls-grid">
          <div className="control-item">
            ...
            <input type="range" min={0.001} max={0.02} step={0.001} value={spread} onChange={(e) => setSpread(Number(e.target.value))} />
          </div>
          <div className="control-item">
            <label>Fill</label>
