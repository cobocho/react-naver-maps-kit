  ...
  return (
    <>
      ...
      <p className="demo-description">
        지도 렌더링 및 기본 옵션을 제어합니다. zoom, center, mapTypeId, 드래그/스크롤 등을 동적으로 변경할 수 있습니다.
      </p>
      ...
      <div className="info-row">
        ...
        {sdkError && <span className="info-chip" style={{ background: "#ffebee", color: "#d32f2f" }}>Error: {sdkError.message}</span>}
      </div>
      ...
      <div className="controls-panel">
        ...
        <div className="controls-grid">
          <div className="control-item">
            ...
            <input type="range" min={1} max={21} value={zoom} onChange={(e) => setZoom(Number(e.target.value))} />
          </div>
          <div className="control-item">
            <label>Center</label>
          ...
          <div className="control-item">
            <label>MapType</label>
            <select value={mapTypeId} onChange={(e) => setMapTypeId(e.target.value as naver.maps.MapTypeIdLiteral)}>
          ...
          <div className="control-item">
            <label>MinZoom</label>
            <input type="number" min={1} max={21} value={minZoom} onChange={(e) => setMinZoom(Number(e.target.value))} />
          </div>
          <div className="control-item">
            <label>MaxZoom</label>
            <input type="number" min={1} max={21} value={maxZoom} onChange={(e) => setMaxZoom(Number(e.target.value))} />
          </div>
          <div className="control-item">
          ...
          <div className="control-item">
            <input type="checkbox" checked={scrollWheel} onChange={(e) => setScrollWheel(e.target.checked)} />
            <label>ScrollWheel</label>
          </div>
          <div className="control-item">
            <input type="checkbox" checked={zoomControl} onChange={(e) => setZoomControl(e.target.checked)} />
            <label>ZoomControl</label>
          </div>
          <div className="control-item">
            <input type="checkbox" checked={mapTypeControl} onChange={(e) => setMapTypeControl(e.target.checked)} />
